...
<h1 style="text-align: center">设备管理</h1>
  ...
  <el-button v-if="myStore.getUserInfo().type!=1" style="position: absolute;right: 4%;top: 5%" @click="goToPersonalLog" type="primary">个人日志</el-button>
  <el-button v-else style="position: absolute;right: 4%;top: 5%" type="primary" @click="goToPeopleManage">员工管理</el-button>
